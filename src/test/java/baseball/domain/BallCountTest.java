...
class BallCountTest {
    ...
    @ParameterizedTest
    @CsvSource(value = {"123:145:1스트라이크", "567:568:2스트라이크", "456:456:3스트라이크"}
            , delimiter = ':')
    ...
    @ParameterizedTest
    @CsvSource(value = {"123:451:1볼", "567:785:2볼", "456:645:3볼"}
            , delimiter = ':')
    ...
    @ParameterizedTest
    @CsvSource(value = {"123:142:1스트라이크 1볼", "567:765:1스트라이크 2볼"}
            , delimiter = ':')
    ...
    @ParameterizedTest
    @CsvSource(value = {"123:456:낫싱", "567:432:낫싱", "345:789:낫싱"}
            , delimiter = ':')
